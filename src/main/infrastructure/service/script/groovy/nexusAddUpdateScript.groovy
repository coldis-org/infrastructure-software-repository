...
@Grab('org.sonatype.nexus:nexus-rest-client:3.16.1-02')
@Grab('org.sonatype.nexus:nexus-rest-jackson2:3.16.1-02')
@Grab('org.sonatype.nexus:nexus-script:3.16.1-02')
